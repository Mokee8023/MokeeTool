...
public class BomberActivity extends Activity implements OnClickListener {
			...
			case API.GET_PHONE_INFORMATION:
				...
				if (msg.obj == null) {
					...
					if(phoneInfo.contains("移动") || phoneInfo.contains("电信") || phoneInfo.contains("联通")){
						MyValuesInt.setSmsNum(MyValuesInt.getSmsNum() - num);
						
						SMSSDK.getVerificationCode("86", phone);
					} else {
						Toast.makeText(getApplicationContext(), "此号码非三大运营商号码", Toast.LENGTH_SHORT).show();
					}
				}
				break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SMSSDK.initSDK(BomberActivity.this, API.MOB_APPKEY, API.MOB_APPSECRET);
	}
